...
const VirusCardBackground = ({ title, value = 0, image, valueColor }) => {
  ...
  return (
    <div className='bg-white w-52 h-24  max-[450px]:w-[140px] max-[450px]:h-[85px] max-[600px]:w-44  relative overflow-hidden rounded-sm shadow-md '>

      <div className='absolute bottom-2 -right-6 w-28 h-28 opacity-10 max-[600px]:bottom-0 max-[450px]:w-24 max-[450px]:h-24'>
