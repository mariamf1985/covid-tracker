...
const VirusCardIcon = ({ title, value = 0, image }) => {
  return (
    <div className='bg-white flex w-48 h-20 relative overflow-hidden rounded-sm shadow-md m-3.5'>
    ...
    <div className='w-full h-full flex flex-col justify-center items-left '>
      ...
      <h3 className='text-3xl font-bold text-primaryLetterColor'>{value}</h3>
    </div>
