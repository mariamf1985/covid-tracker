...
const CountryButton = ({ image, country, value }) => {
  return (
    <button className="flex items-center bg-white border text-primaryLetterColor w-[150px] h-12 px-3 py-2 mt-3 ml-4 mr-2 transform transition-transform hover:scale-110">
