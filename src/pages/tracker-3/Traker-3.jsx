...
const Traker3 = () => {
  ...
  return (
    <>
     <div className=" xl:w-[70%] lg:w-[92.5%] md:w-[90.5%] min-[375px]:w-[81.5%] max-[375px]:w-[79%] bg-primarybackground h-screen float-right p-[25px] flex flex-col justify-start border shadow font-[poppins]">
